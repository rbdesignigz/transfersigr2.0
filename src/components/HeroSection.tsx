    ...
    <section className="relative w-full h-[600px] md:h-[650px] flex items-center justify-center overflow-hidden border-b border-[#65d6e9]/20 pt-16">
      ...
      <div className="relative z-10 text-center px-6 w-full max-w-5xl mx-auto flex flex-col items-center gap-6 mt-6">
        ...
        <div className="mt-10 w-full max-w-2xl relative p-[2px] rounded-lg overflow-hidden shadow-[0_0_40px_rgba(101,214,233,0.15)] group">
          ...
          <div className="absolute top-1/2 left-1/2 w-[300%] h-[300%] -translate-x-1/2 -translate-y-1/2 bg-[conic-gradient(from_0deg,transparent_85%,#65d6e9_100%)] animate-[spin_3s_linear_infinite] opacity-100"></div>
          
          {/* Inner Content Wrapper */}
          <div className="relative w-full h-full bg-[#0a0c0d]/95 backdrop-blur-xl p-4 md:p-5 flex items-center rounded-lg">
            ...
            <div className="flex-grow flex items-center gap-3 px-3">
              <Search className="h-5 w-5 text-[#65d6e9]" />
              <input
                type="text"
                value={searchTerm}
